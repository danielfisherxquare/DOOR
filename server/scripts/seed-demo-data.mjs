...
const orgSeeds = [
    {
        ...
        members: [
            { code: 'EAST-001', username: 'east.admin', name: '林子昂', role: 'org_admin', title: '部门经理', position: '赛事总监', department: '赛事运营部', type: 'employee', idNo: '310101199001011234', phone: '13800010001', modules: ['admin:races', 'admin:members', 'admin:credentials', 'admin:finance'] },
            { code: 'EAST-014', username: 'east.ops', name: '顾清禾', role: 'race_admin', title: '高级员工', position: '现场执行经理', department: '执行交付组', type: 'employee', idNo: '310101199204141235', phone: '13800010014', modules: ['ops:home', 'ops:scan', 'ops:bib-pickup', 'app:map', 'app:credentials'] },
