...
router.post('/credentials/:raceId/:credentialId/issue', operationLog({ module: 'credential', businessType: 'UPDATE', titleFactory: (req) => '签发证件: ' + (req.params?.credentialId || '') }), requireRaceAccess('raceId'), async (req, res, next) => {
    try {
