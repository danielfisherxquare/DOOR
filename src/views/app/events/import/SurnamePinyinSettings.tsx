    ...
    return (
        <div style={{ padding: '8px 0' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap', marginTop: 12 }}>
                <button className="btn btn--primary" onClick={handleSave}>保存补充映射</button>
                <button className="btn btn--secondary" onClick={handleLoadExamples}>载入示例</button>
                <button className="btn btn--secondary" onClick={handleReset}>清空本地补充</button>
