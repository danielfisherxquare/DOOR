...
function MatchingCenterModal({ visible, onClose }) {
  const { pendingMatches, records, resolvePendingMatch, rejectPendingMatch, isLoading } =
  ...
  return (
    <div className="matching-modal-overlay" onClick={onClose}>
      <div className="matching-modal" onClick={(e) => e.stopPropagation()}>
        ...
        {operationError && (
          <div
            className="matching-modal__error"
            style={{
              padding: '8px 20px',
              margin: '0 20px',
        ...
        <div className="matching-modal__content">
                ...
                <div className="matching-modal__payment-row">
                  ...
                  <span className="matching-modal__payment-value">
                    {currentMatch.payment_data?.payee ||
                      currentMatch.payment_data?.targetName ||
                      '未解析'}
                  </span>
                </div>
                <div className="matching-modal__payment-row">
          ...
          <div className="matching-modal__candidates">
            ...
            {candidates.length > 0 ? (
              ...
              <div className="matching-modal__no-candidates">未能找到候选记录</div>
            )}
          </div>
        </div>
