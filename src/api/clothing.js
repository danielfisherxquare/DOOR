...
export const clothingApi = {
     ...
     */
    getLimits: (raceId) =>
        request.get(`${getBasePath()}/limits/${raceId}`),
     ...
     */
    saveLimit: (data) =>
        request.post(`${getBasePath()}/limits`, data),
     ...
     */
    saveLimits: (items) =>
        request.post(`${getBasePath()}/limits/bulk`, { items }),
     ...
     */
    incrementUsed: (data) =>
        request.post(`${getBasePath()}/limits/increment`, data),
    ...
    getStatistics: (raceId) =>
        request.get(`${getBasePath()}/statistics/${raceId}`),
}
